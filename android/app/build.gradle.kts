...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications (the in-app push display) uses java.time on older Android
        // versions, which only core-library desugaring provides.
